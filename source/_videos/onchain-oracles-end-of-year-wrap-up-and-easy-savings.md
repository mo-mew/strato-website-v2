...
date: 2025-12-13
hosts: ["Victor Wong", "Kieren James-Lubin", "Michael Tan"]
description: "End of Year Wrap Up and Easy Savings"
embed:
...
**[[00:18]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=18s) Kieren James-Lubin:** Thanks, [Victor](/people/victor-wong). So we completed our relaunch onto version 2 a [little over a month ago](/blog/announcing-v2-mainnet/), and wanted to monitor the system a little bit to just make sure everything was working well before we turned rewards back on. We have done that as of this Thursday, and not been loud about it just yet. We've been testing a little bit internally and it seems all good to go. So [Michael](/people/michael-tan) will show you a little bit about what I'd call season one of our rewards program. Season zero was very successful bringing in about eight million of TVL. And we hope to see similar and greater results with the new rewards program. Over to [Michael](/people/michael-tan). 
...
**[[03:50]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=230s) John Crain:** Hey, [Victor](/people/victor-wong). Hey, everyone. Good to see you guys. Thanks for having me.

**[[03:54]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=234s) Victor Wong:** [John Crain](https://x.com/SuperRareJohn), of course, as everyone knows, is the founder of [SuperRare](https://superrare.com/). But do you want to give a quick intro for anyone who is not intimately familiar with all the amazing things you've done over the past couple of years?
...
**[[04:45]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=285s) Victor Wong:** Yeah. I remember how you heard about the hackathon or Ethereum generally. Obviously we met there, but like, what was that? Yeah. Well, your idea.
...
**[[06:02]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=362s) John Crain:** Yeah, yeah, yeah, for sure. Exactly, yeah. I think the Monday after, I feel like I immediately quit and started working with you guys full-time on BlockApps.
...
**[[12:05]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=725s) Victor Wong:** What do you think the biggest challenge was in running a DAO? Because I think all of us had that sort of as an ideal state with the crypto Kool-Aid, running things completely decentralized. What do you think are the challenges you faced when you did it and that are still out there, do you think?

**[[12:22]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=742s) John Crain:** Yeah. I mean, I think still one of the bigger challenges is regulatory. Like you have, you're kind of trying to read the tea leaves and then rather than just making the bet, you're like, okay, well, this is the simplest, best decision. You're like, okay, well, this is not clear what this means. So maybe we should do this. And like, how do we not get in trouble for trying to experiment. And it's obviously, the position is friendlier, but there's still no clear rules. It's like, obviously like the [Gensler era](https://en.wikipedia.org/wiki/Gary_Gensler) of enforcement.
...
**[[17:02]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=1022s) Victor Wong:** Yeah.

**[[17:03]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=1023s) John Crain:** We, you know, you kind of had to get both first. So, I mean, we started just out of like, it really started as just me kind of experimenting and building. And so we were like, started with the minting tools. I was going around demoing, talking to people. And I guess we, it first kind of piqued interest of the artists. I was talking about how it would work. And then when we first launched, we kind of had, so there's [Jason Bailey](https://www.artnome.com), who was kind of an early digital art advocate, big writer. He ran a company or runs a company called Club NFT that does NFT art backups. Yeah. And he hit us up and was like, hey guys, we'd been talking to him. And he was like, I know you're getting close with your product. I want to buy this art on Monday. Can I do it on [SuperRare](https://superrare.com/)? And I looked at Charlie and I was like, do you, Jason wants to buy something on mainnet on Monday. Like, what can we do? That was in like 36 hours.
...
**Victor Wong:** I'm getting flashbacks to when Microsoft said we want to launch blockchain as a service with you at [DEVCON1](https://earlydaysofeth.org).
...
**[[18:12]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=1092s) John Crain:** Exactly. Oh my God.

**[[18:14]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=1094s) Victor Wong:** There are many parallels. Nothing like a good deadline to get. Yes, exactly. Especially with a big partner that can make or break you, right?

**[[18:22]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=1102s) John Crain:** So yeah, just don't have live demos on the end of all of that as well. Yeah, exactly. That's when it gets real risky. We actually, so when we did it, there was a funny bug with the React stuff. So we were like live, like helping, we were like live streaming, or not live streaming, but screen sharing the transaction with this artist [Robbie Barrat](https://x.com/VIDEODROME) and [Jason](https://www.artnome.com). And we're literally pushing fixes. It was like, oh, we didn't know. I didn't expect that to happen. Like, okay, one second. All right, it's deployed. Just reload the page.

**[[18:52]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=1132s) Victor Wong:** Lots of cache clearing. I remember about that.
...
**[[24:38]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=1478s) John Crain:** Yeah, just wait. Yeah. Like 2021 people were just buying Picassos on their phones and crazy apes.

**[[24:46]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=1486s) Victor Wong:** Crazy apes, right? Everything. [Ether Rocks](https://etherrock.com/).

**[[24:49]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=1489s) John Crain:** I remember when [Ether Rocks](https://etherrock.com/) were like the prices exploding and I was like, this is truly amazing. Yeah, I think the models have to change. And just if you think what the Internet's done as far as shopping, right? It's like you can price compare easily on your phone in any store, right? There's no kind of price arbitrage. You're going to look up the price of something, you can scan something, figuring it, ask [ChatGPT](https://chatgpt.com/), what is this? How much should it cost? And so I think the art world has really, it has been an insider's game of who knows who and what's the real price, the marketed price versus what was actually paid. And I think that's gonna slowly unwind and we'll end up with a market structure where pricing is just much more transparent. You can see things on chain. And I think that's kind of part of the opportunity is as the market becomes more efficient, we'll have the best tools to service the new structure.
...
**[[26:15]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=1575s) John Crain:** Yeah, they have, I mean, like they're all, [Christie's](https://www.christies.com) inside, a lot of the big, or most of the auction houses are private. So I don't know how big their businesses are, but they do have, yeah, there's like people will inherit art and it's like they don't really care necessarily and their advisor was like don't sell that, you should just take out a loan. And so they do have them.

**[[26:35]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=1595s) Victor Wong:** But that seems like a classic conflict of interest to your point, right, like we'll tell you how much it's worth and we'll loan you based on that.

**[[26:42]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=1602s) John Crain:** Yeah, it's very one-sided and you can't really shop it around. It's ultra specialized information.
...
**[[30:22]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=1822s) Victor Wong:** I'm curious about the decision to, you mentioned starting the gallery and everyone's talking about RWAs and kind of bringing real world stuff into the blockchain, but you're kind of doing the opposite. What was the decision to start a physical gallery and why did you decide that was a logical next step for you guys?

**[[30:40]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=1840s) John Crain:** Yeah. I mean, just, it's kind of part of how the market works. So people like getting together and a lot of the art, it's like, you can look at it on your phone, but if you see it on the huge projector, there's like a 10 by 10 CRT TV wall, it really looks different. So I think part of it is community building. It's a space people can show up. And then part of it's like the art really does just look different. So I think as far as, and after, you still, people are like, okay, these are just nonsense JPEGs, it's [Ether Rocks](https://etherrock.com/) 2.0. And so it's kind of telling the story to everyone else. Cause at the end of the day, it's still a demand constrained market and we're trying to grow the collector base.
...
**[[32:37]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=1957s) Victor Wong:** What, people like, is [Courtyard](https://courtyard.io/) still going, right? I think.

**[[32:40]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=1960s) John Crain:** Yeah, they're doing great. Yeah. It's, you kind of like you have the speculative aspect, but also if you're a serious collector, you can get real things.

**[[32:50]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=1970s) Victor Wong:** Okay, last question for you, unless anyone else has one, but what are you most excited about in any aspect of the blockchain space right now?

**[[33:00]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=1980s) John Crain:** Most excited? I mean, it's obviously, we've all been working on this for a super long time, but I do think if you look at even just [BlackRock](https://blackrock.com) putting treasuries on chain with different partners, art's moving on chain, everything literally is going to, that is moving on chain. I think that's actually finally, it used to just be a mantra people would say to help themselves feel important, but I think we're finally getting there. We're like, holy, everything is moving on chain. That's actually happening. So it's like real world assets, digital assets. I think just, yeah, liquidity is increasing. I think it's generally net positive for everyone. It feels actually like it's finally happening, so.

**[[33:42]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=2022s) Victor Wong:** Yeah, it's taken way longer, 10 years, but we're still here and we're still doing it.
...
**[[34:30]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=2070s) Victor Wong:** [Offline by SuperRare](https://offline.superrare.com/). Well, awesome. Thank you for joining us and take care, everyone.

**[[34:35]](https://www.youtube.com/watch?v=mqStnmOwuR0&t=2075s) John Crain:** Thank you. Thanks for having me.
